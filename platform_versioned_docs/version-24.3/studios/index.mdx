...
- `<tool_version>-<major>.<minor>`, such as `4.2.3-0.7`. When adding a new Studio container template image this is the tag displayed in Seqera Platform.
