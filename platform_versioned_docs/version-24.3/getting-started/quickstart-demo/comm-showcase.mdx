...
- Perform interactive analysis of pipeline results with [Studios](../../studios/index.mdx)
...
:::note
See [Studios](../../studios/index.mdx) to learn how to create Studios in your own workspace. 
:::
