...
| Registry server | The container registry server name                                                      | `https://<aws_account_id>.dkr.ecr.<region>.amazonaws.com` or use `public.ecr.aws` if you want to access images from a public ECR. |
