...
11. If the Azure Batch Pool you have selected has an attached user-assigned **Managed Identity**, you can select it here.
...
#### Using a Managed Identity to authenticate to Azure Services
