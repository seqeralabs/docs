...
11. If the Azure Batch Pool you have selected has an attached user-assigned **Managed Identity**, you can select it here and Nextflow will use the Managed Identity to authenticate to the Azure Storage account and Azure Batch account instead of using access keys.
