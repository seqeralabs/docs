...
Seqera Platform provides an interactive tertiary analysis environment that you can enable for organizational workspaces. For more information enabling Data Studios, see [Data Studios deployment](./enterprise/data-studios.mdx).
