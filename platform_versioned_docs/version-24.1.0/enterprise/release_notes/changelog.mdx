...
### 24.1.0 Enterprise - June 2024

- Login: Email login can be removed in the configuration file
- Extended Data Roles: Added the ability to view role counts
...
- Fixed: Do not autoselect first available options in the pipeline input form dropdowns
- Deprecate EBS autoscale in the user interface
- Bump nf-launcher:j17-24.04.2
