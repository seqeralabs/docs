...
Three additional user roles have been introduced alongside Data Studios. These roles provide flexibility for admins to provide users with the permissions they need, without compromising security. The roles support the following actions:
