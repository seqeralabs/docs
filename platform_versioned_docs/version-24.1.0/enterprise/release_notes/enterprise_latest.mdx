...
Seqera Platform Enterprise version 24.1.0 introduces three new features: Data Studios (in public preview), Data Studios, and managed identities. A number of bug fixes and performance enhancements have also been included in this major release.
...
The **Connect** user role has been added to the existing user roles. User roles provide flexibility for admins to provide users with the permissions they need, without compromising security. Existing roles have been updated with functionality related to Data Studios:
