...
Seqera Platform Enterprise version 24.1.0 introduces three new features: Data Explorer, Data Studios (in public preview), and managed identities. A number of bug fixes and performance enhancements have also been included in this major release.
