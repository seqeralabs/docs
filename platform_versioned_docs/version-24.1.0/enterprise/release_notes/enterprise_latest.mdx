...
The **Connect** user role has been added to the existing user roles. User roles provide flexibility for admins to provide users with the permissions they need, without compromising security. The roles support the following actions:
