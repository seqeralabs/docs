...
3. Associate the user-assigned Managed Identity with the Azure Batch Pool. See [Set up a Managed Identity in your Batch Pool](https://learn.microsoft.com/en-us/troubleshoot/azure/hpc/batch/use-managed-identities-azure-batch-account-pool#set-up-managed-identity-in-your-batch-pool) for more information.
