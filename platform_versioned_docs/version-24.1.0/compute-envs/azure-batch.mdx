...
4. When you set up the Seqera compute environment, select the Azure Batch Pool by name and enter the Managed Identity Client ID in the specified field as instructed above.
