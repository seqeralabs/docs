...
The command line is called `tw`. This allows you to manage Seqera Platform elements like pipelines, actions, and compute environments in the terminal.
...
- **A Nextflow-like experience**: The CLI provides a developer-friendly environment. Pipelines can be launched with the CLI similar to Nextflow, but with the benefits of the Seqera Platform which provides monitoring, logging, resource provisioning, dataset management, and collaborative sharing.
