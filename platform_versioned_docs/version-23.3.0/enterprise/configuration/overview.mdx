...
Configuration values to enable computing platforms and customize Tower Forge resource naming.
...
| Environment variable   | Description                                                                   | Value           |
| ---------------------- | ----------------------------------------------------------------------------- | --------------- |
| `TOWER_ENABLE_OPENAPI` | Enable the OpenAPI documentation endpoint, e.g., [tower.nf/openapi/index.html](https://api.cloud.seqera.io/openapi/index.html). | Default: `true` |
...
Logging-related configuration values to aid troubleshooting.
...
Root users can access application audit logs from the [Admin panel](../../administration/overview.mdx). Audit logs include administration, security, and application resource events.
