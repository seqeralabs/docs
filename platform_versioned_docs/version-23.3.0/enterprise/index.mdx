...
:::tip
Before installing Seqera Platform Enterprise, we recommend that you [**Sign up**](https://tower.nf) and try the hosted cloud version for free. You can also request a [**demo**](https://cloud.tower.nf/demo/) for deployment to your own cloud or on-prem infrastructure.
:::
