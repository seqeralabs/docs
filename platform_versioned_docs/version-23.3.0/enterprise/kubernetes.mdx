...
Download and configure a [ConfigMap](_templates/k8s/configmap.yml) as detailed on the [configuration](configuration/overview.mdx) page.

To deploy the ConfigMap to your cluster, run the following:
