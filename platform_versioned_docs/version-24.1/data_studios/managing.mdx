---
title: "Managing studio sessions"
...
You'll be returned to the Data Studios landing page that displays the list of data studios in your workspace. You can inspect the configuration details of the data studio that you created by selecting the data studio session name. The data studio you created will be listed with a status of either **stopped** or **starting**, depending on whether you elected to only add the data studio or to start it as well.
