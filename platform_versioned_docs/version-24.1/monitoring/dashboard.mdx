...
The Seqera Platform **Dashboard**, accessed from the user menu, provides an overview of runs and data studios sessions in your personal and organization workspaces.

## Runs

You can explore the status of runs in your personal and in organizational workspaces. On the **Dashboard** page page, select **Runs**.
...
If your instance of Seqera Platform has [Data Studios][ds] enabled, you can explore the status of data studios in your organizational workspaces. On the **Dashboard** page page, select **Data Studios**.

A summary of the number of data studios in each state is available:
...
The **Dashboard** view defaults to all organizations and workspaces you can access. Select the **View** dropdown menu to filter by data studios session status.

You can filter by data studios session state. To filter the set of runs, select **Filter**. When a filter is applied, the button icon and color changes.

### Export data

Select **Export data** in the filter panel near the top of the page to export dashboard data for the organization and workspace in a CSV file.
