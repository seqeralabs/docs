...
The **Dashboard** view defaults to all organizations and workspaces you can access. Select the **View** dropdown menu to filter by organization(s) and workspace(s). Select a status in the table to navigate to a list filtered by the status selected.
