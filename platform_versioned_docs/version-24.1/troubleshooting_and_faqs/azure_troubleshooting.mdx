...
This can occur if a tool/library in your task container requires SSL certificates to validate the identity of an external data source. Mount SSL certificates into the container to resolve this issue. See [SSL/TLS](../enterprise/configuration/ssl_tls.mdx#configure-seqera-to-trust-your-private-certificate) for more information.
