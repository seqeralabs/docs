...
[Seqera Pipelines](https://seqera.io/pipelines) is a curated collection of high quality open-source pipelines. Each pipeline includes a test dataset to use in a test run in just a few steps.
