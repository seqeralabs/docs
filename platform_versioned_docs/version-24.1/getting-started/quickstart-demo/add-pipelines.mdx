...
[Seqera Pipelines](https://seqera.io/pipelines) provides a curated collection of high quality open-source pipelines. Each pipeline includes a curated test dataset to use in a test run in just a few steps.
