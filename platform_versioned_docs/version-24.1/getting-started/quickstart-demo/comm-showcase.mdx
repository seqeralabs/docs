...
- Perform tertiary analysis of pipeline results with [Data Studios](../../data_studios/index.mdx)
...
The workspace also includes three preconfigured AWS Batch compute environments to run Showcase pipelines, and various datasets and public data sources (accessed via Data Explorer) to use as pipeline input. 
