...
- Perform tertiary analysis of pipeline results with [Data Studios](../../data_studios/overview.mdx)
...
:::note
See [Data Studios](../../data_studios/overview.mdx) to learn how to create data studios in your own workspace. 
:::
