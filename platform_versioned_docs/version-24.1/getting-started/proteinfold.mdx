...
Given the data sizes and computational intensity, production pipelines require GPUs for optimal performance, multi-core CPUs for non-GPU tasks, and low-latency, high-throughput cloud storage file handling.
...
### Pipeline performance guidelines and metrics? TBD 
