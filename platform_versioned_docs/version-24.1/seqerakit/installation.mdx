...
If you already have [Seqera Platform CLI](https://github.com/seqeralabs/tower-cli#1-installation) and Python installed on your system, install `seqerakit` directly from [PyPI](https://pypi.org/project/seqerakit/):
...
Create a Seqera Platform access token using the [Seqera Platform](https://cloud.seqera.io/) web interface via the **Your Tokens** page in your profile.
...
For Platform Enterprise installations, you must specify the custom API endpoint used to connect to the Platform. Export the API endpoint environment variable:
