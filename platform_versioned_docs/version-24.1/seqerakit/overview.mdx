...
`seqerakit` is a Python wrapper for the [Platform CLI](../cli/overview.mdx). Use `seqerakit` to automate the creation of all Seqera Platform entities via a simple configuration file in YAML format.
