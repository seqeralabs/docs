...
1. Retrieve CLI options:
    ...
    Obtain a list of available CLI options for defining your YAML file with the Platform CLI help command. For example, to add a pipeline to your workspace, view the options as follows:
