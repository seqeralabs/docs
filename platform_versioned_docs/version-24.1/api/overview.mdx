...
<p>
  <Button to="https://cloud.seqera.io/openapi/index.html" wrapParagraphClassName="float-right" className="mr-3">View API reference</Button>{" "}
  <Button to="https://cloud.seqera.io/openapi/seqera-api-latest.yml" outline>Download API schema</Button>
</p>
...
<Button to="https://cloud.seqera.io/tokens" outline>Create an access token</Button>
:::
...
<Button to="https://cloud.seqera.io/tokens">Create an access token</Button>
