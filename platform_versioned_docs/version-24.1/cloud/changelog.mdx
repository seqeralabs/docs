...
- Style: Fix visual glitches in launch form
- Improvement: Data Explorer: Highlight invalid custom datalinks
- Fix: Datalink status always null
- Feature: Data Studios: Make StudioDetailsPage tabs routable
- Fix: Update lastUsed on compute environment when creating a data studio job
[PLAT-493] fix broken data studios e2e test after change in mounted data disabled selection logic by @alvaromartmart in #7560
...
- Improvement: Add Posthog integration
