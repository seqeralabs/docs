...
### v24.2.0_cycle23 Cloud - 28 August 2024

Fix: [Data Explorer] enable task workdir navigation using Data Explorer in personal workspaces by adding routing
...
Fix: Hide compute environment variables section actions when component is disabled (previously indicated that env vars could be edited in this state)
