...
<details>
  ...
  The optional `--config` flag is used to pass a custom Nextflow configuration file — configuration values passed here override the same values in the default pipeline repository `nextflow.conf` file and the compute environment **Nextflow config** field in Platform.
...
<details>
  ...
  The optional `--config` flag is used to pass a custom Nextflow configuration file — configuration values passed here override the same values in the default pipeline repository `nextflow.conf` file and the pipeline or compute environment **Nextflow config** field in Platform.
