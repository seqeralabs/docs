...
1. Create a [secret][kubectl-secret] with the `name` and `secret` values retrieved in the previous step:
...
1. Download the appropriate manifest and configure it according to your infrastructure:
