...
:::note
Platform login sessions remain active as long as the application browser tab remains open and active. When the browser window is terminated, automatic logout occurs within 6 hours.
:::
