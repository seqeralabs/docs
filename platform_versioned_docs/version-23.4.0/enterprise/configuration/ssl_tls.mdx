...
## Azure deployments: Use Application Gateway for TLS termination and load balancing

See [Configure an Application Gateway](https://learn.microsoft.com/en-us/azure/application-gateway/create-ssl-portal) to set up an Application Gateway with TLS termination in the Azure portal. 

See [Import a certificate in Azure Key Vault](https://learn.microsoft.com/en-us/azure/key-vault/certificates/tutorial-import-certificate?tabs=azure-portal) to store your TLS certificate keys securely with Azure. 
