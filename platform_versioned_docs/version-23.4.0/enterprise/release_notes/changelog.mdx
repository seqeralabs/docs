...
- Allowed: S3 `PutObjectTagging` to instance role created by Tower Forge (#4511) [c8c8e76a]
- Allowed: Exact match search filters (#4396) [d90acc18]
- Allowed: To share a Tower Agent connection (#4395) [1cfaee91]
- Allowed: The customisation prefix of Tower Forge resources (#4693) [67072462]
