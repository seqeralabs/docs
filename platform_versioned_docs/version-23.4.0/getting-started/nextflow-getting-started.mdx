...
You can install Nextflow locally, or run it in a Docker container. Another option is to try Nextflow out in the [Nextflow Gitpod training environment](https://gitpod.io/#https://github.com/nextflow-io/training) before ever installing anything on your own machine. 
