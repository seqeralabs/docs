...
You can create multiple workspaces within an organization context and associate each of these workspaces with dedicated teams of users, providing fine-grained access control for each team. You can see more [here](../orgs-and-teams/workspace-management.mdx).