...
1. Expand the [Pipeline secrets](../secrets/overview.mdx) dropdown to select user or workspace secrets to be used during the return, if needed.

1. Expand the **Advanced options** dropdown to apply advanced configuration options, if needed. See your [compute environment](../compute-envs/overview.mdx) page for further details.
