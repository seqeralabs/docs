...
:::tip
See [the basic configuration information](../enterprise/configuration/overview.mdx#basic-configuration) to learn how to add root users, using the `TOWER_ROOT_USERS` environment variable, to your account.
:::
