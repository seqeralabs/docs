...
See [Organization management](../orgs-and-teams/organizations) for more information. 
...
You can only add existing users to an organization. You can't remove a membership if the user being removed is the last owner of the selected organization until you promote another user to **Owner** first.
...
See [Workspace management](../orgs-and-teams/workspace-management) for more information.
...
There are two organization user roles in Seqera:
