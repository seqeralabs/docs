...
:::note
This feature is available from Seqera Platform v22.3.
:::
...
The **Dashboard** view defaults to all organizations and workspaces you can access. Select the **View** drop-down menu to filter by specific organizations and workspaces, or to view statistics for your personal workspace only.
...
For each organization you have access to, run totals for your selected filters are displayed.
