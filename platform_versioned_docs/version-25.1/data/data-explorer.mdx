...
Data Explorer supports file uploads to your private cloud storage buckets. From the **View cloud bucket** page, select **Upload file** to select the files or folders you wish to upload. You can upload up to 300 files at a time via the Platform interface.
