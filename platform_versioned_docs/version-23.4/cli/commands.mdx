...
<details>
  ...
  Run `tw datasets add -h` to view the required and optional fields for adding your dataset.
  ...
  Add a preconfigured dataset file to a workspace:
  ...
  :::note 
  Include the `--header` flag if the first row of your samplesheet file is a header.
  :::
