...
The role assigned to a user affects what functionality is available in Data Explorer. The specific functionality for each role is described in the following list of roles:

- **View** role: Can only view contents of cloud storage buckets. Cannot download, upload, or preview.
- **Launch** role: Can only view contents of cloud storage buckets. Cannot download, upload, or preview.
- **Connect** role: Can only view contents of cloud storage buckets. Cannot download, upload, or preview.
- **Maintain** role: Can view, download, upload, and preview contents of cloud storage buckets.
- **Admin** role: Can view, download, upload, and preview contents of cloud storage buckets.
- **Owner** role: Can view, download, upload, and preview contents of cloud storage buckets.

For more information on roles in Seqera Platform, see [Participant roles][roles].

[roles]: ../orgs-and-teams/workspace-management.mdx#participant-roles
