...
- Perform tertiary analysis of pipeline results with [Data Studios](../../data-studios.mdx)
...
:::note
See [Data Studios](../../data-studios.mdx) to learn how to create data studios in your own workspace. 
:::
