...
<details>
 ...
 If a task fails, a good place to begin troubleshooting is the task's work directory. Click on the data explorer pane of the task window and check the files in the task working directory.
