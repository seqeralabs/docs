...
This guide details how to run RNA sequencing data analysis, from quality control to differential expression analysis, on a cloud compute environment in Platform. It includes: 
