...
- The **Config view** displays raw configuration text that you can edit directly. Select JSON or YAML format from the **View as** dropdown.
...
**Data Studios** streamlines the process of creating interactive analysis environments for Platform users, with built-in templates for platforms like Jupyter Notebook, RStudio, and VSCode. Creating a data studio in Seqera Platform is as simple as adding and sharing pipelines or datasets.
