...
This guide details how to run bulk RNA sequencing (RNA-Seq) data analysis, from quality control to differential expression analysis, on a cloud compute environment in Platform. It includes: 
...
The [Fusion](../supported_software/fusion/fusion.mdx) file system enables seamless filesystem I/O to cloud object stores for
simpler pipeline logic and faster, more efficient execution. While Fusion is not required to run nf-core/rnaseq, it is recommended for optimal performance. See [Pipeline performance](#pipeline-performance) at the end of this guide.
...
:::info
The [nf-core/rnaseq](https://github.com/nf-core/rnaseq) pipeline is a highly configurable and robust workflow designed to analyze RNA-Seq data. It performs quality control, alignment, quantification, and differential expression analysis.
:::
