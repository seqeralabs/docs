...
The RStudio environment can be configured with the packages you wish to install and the R scripts you wish to run. For the purposes of this guide, the following environment configuration can be used to analyze the gene level counts of your RNA-seq data:
