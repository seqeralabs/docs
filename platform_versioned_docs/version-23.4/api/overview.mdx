...
<Button to="https://cloud.seqera.io/openapi/index.html">Platform OpenAPI reference</Button> 

The API and its interactive reference is built on the OpenAPI standard. Download the current OpenAPI schema file here: 

<Button to="https://cloud.seqera.io/openapi/seqera-api-latest.yml">Download Platform OpenAPI schema</Button>
