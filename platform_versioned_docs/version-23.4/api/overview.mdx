...
<Button to="https://cloud.seqera.io/tokens" alt secondary medium>Create an access token</Button>
:::

<Button to="https://cloud.seqera.io/openapi/index.html" alt blue medium>Platform OpenAPI reference</Button> 

The API and its interactive reference is built on the OpenAPI standard. Download the current OpenAPI schema file here: 

<Button to="https://cloud.seqera.io/openapi/seqera-api-latest.yml" alt blue medium>Download Platform OpenAPI schema</Button>
