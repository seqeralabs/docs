...
As an **organization owner**, access the organization page from the organizations and workspaces drop-down menu, or open the user menu and select **Your organizations** to view and edit your organizations. As a root user, you can also edit organizations from the [Admin panel](../administration/overview.mdx).
...
:::note
**Owners** have full read/write access to modify members, teams, collaborators, and settings within an organization. **Members** are limited in their actions.
:::
