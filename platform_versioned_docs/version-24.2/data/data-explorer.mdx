...
If you remove a cloud storage bucket that is associated as a data link with a Studio, the data link is automatically removed from the Studio configuration.
