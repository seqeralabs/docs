...
<details open>
  ...
  Manage [Studio sessions](../data_studios/index.mdx) hosted in Seqera Platform. Studio sessions allow interactive analysis using Jupter, RStudio, VSCode and Xpra. Additional custom analysis environments can be defined as needed.
  ...
  tw studios view -i 23ce7967 -w community/showcase
    ...
    DataStudio at workspace '[community / showcase]'
 ...
 ---------------------+------------------------------------------------------------
  ...
  Templates are container image templates are the foundation for Studio sessions. See [Container image templates](../data_studios/index.mdx#container-image-templates) for more information.
  ...
  --memory=8192
    ...
    Data Studio 2aa60bb7 CREATED at [community / showcase] workspace.
  ```
  ...
  tw studios start -i 2aa60bb7 -w community/showcase
    ...
    Data Studio 2aa60bb7 START successfully submitted at [community / showcase] workspace.
  ...
  tw studios stop -i 13083356 -w community/showcase
    ...
    Data Studio 13083356 STOP successfully submitted at [community / showcase] workspace.
  ```
  ...
  Checkpoints at data studio 19a3abbd at [community / showcase] workspace:
  ...
  Add a new session from an existing parent Studio session and checkpoint. See [Session checkpoints](../data_studios/index.mdx#session-checkpoints) for more information.
  ...
  -a
    ...
    Data Studio 19a3abbd CREATED at [community / showcase] workspace and auto started.
  ```
  ...
  Delete a Studio session from a workspace.

  ```bash
  tw studios delete -i 2aa60bb7                                                                              

  Data Studio 2aa60bb7 deleted at [community / showcase] workspace.
  ```
</details>
