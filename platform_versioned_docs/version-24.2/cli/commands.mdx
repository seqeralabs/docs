...
Manage [Studio sessions](../data_studios/index.mdx) hosted in Seqera Platform. Studio sessions allow interactive analysis using Jupyter, RStudio, VSCode, and Xpra. Additional custom analysis environments can be defined as needed.
 ...
 ---------------------+------------------------------------------------------------
  ...
  Template            | public.cr.seqera.io/platform/studio-jupyter:4.1.5-0.7 
  Mounted Data        |                                                            
  Compute environment | aws-studios-sandbox-ireland-16cpus                     
  Region              | eu-west-1                                                  
  GPU allocated       | 0                                                          
  CPU allocated       | 2                                                          
  ...
  tw studios templates -w community/showcase
    ...
    Available templates for Studios:
     ...
     Templates                                                     
    ---------------------------------------------------------------
     public.cr.seqera.io/platform/studio-jupyter:4.2.5-0.7    
     public.cr.seqera.io/platform/studio-rstudio:4.4.1-u1-0.7 
     public.cr.seqera.io/platform/studio-vscode:1.93.1-0.7    
     public.cr.seqera.io/platform/studio-xpra:6.2.0-r2-1-0.7
  ```
