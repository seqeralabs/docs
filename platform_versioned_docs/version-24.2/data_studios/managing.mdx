...
## Limit Data Studio access to a specific cloud bucket subdirectory {#cloud-bucket-subdirectory}
...
1. Complete the following fields:
   ...
   - **Bucket path**: Enter the full path to the subdirectory of the bucket that you want to use with your Data Studio, such as `s3://1000genomes/data`.
...
1. Select **Add** to create the cloud bucket.

When adding a Data Studio, when you configure **Mounted data**, you can select the cloud bucket that you created with the previous instructions.
