...
1. Specify the session lifespan:
   ...
   - If you want to sessions to automatically shutdown after a specific lifetime, select **Automatically stop the session after a predefined lifespan**, and then input a **Lifespan** in hours between 1-120 hours.
