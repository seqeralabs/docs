...
- `3://biopharmaX/experiments/project-A/experiment-1/data`: Subdirectory to mount in a Studio session

You can expose the `s3://biopharmaX/experiments/project-A/experiment-1/data` bucket subdirectory in a studio session as `/workspace/data/biopharmaxs-project-a-experiment-1-data`.
