...
You can expose only the `s3://biopharmaX/experiments/project-A/experiment-1/data` in a studio session as `/workspace/data/biopharmaxs-project-a-experiment-1`
