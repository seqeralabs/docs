...
To see the latest versions of the images, see [public.cr.seqera.io](https://public.cr.seqera.io/). Seqera recommends that you use the latest available version of the container image templates.
