...
If you're restricted from using public container registries, see Seqera Enterprise release [instructions](../enterprise/upgrade.mdx#nextflow-launcher-image) for the specific image to set as the default when invoking pipelines.
