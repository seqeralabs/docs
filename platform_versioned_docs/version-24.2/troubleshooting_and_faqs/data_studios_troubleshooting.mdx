...
A security scan of the latest Seqera-provided VSCode [container template](../data_studios#container-image-templates) returns multiple false positive critical vulnerabilities from both Trivy and Docker Scout (CVE-2019-19919, CVE-2021-23369, CVE-2021-23383, CVE-2019-20920). Both systems incorrectly map the VSCode extension `handlebars` with the npm extension `handlebars`. This is an [open known issue](https://github.com/aquasecurity/trivy/discussions/6112).
