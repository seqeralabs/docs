---
title: " Enterprise 24.2"
description: "Seqera Platform Enterprise version 24.2 release notes"
date: "4 July 2024"
tags: [changelog]
---

Seqera Platform Enterprise version 24.2 introduces three new features: Data Studios (in public preview), Data Explorer, and managed identities. A number of bug fixes and performance enhancements have also been included in this major release.
...
For a detailed list of all changes, see the Platform Enterprise [changelog](https://docs.seqera.io/changelog/tags/seqera-enterprise).
