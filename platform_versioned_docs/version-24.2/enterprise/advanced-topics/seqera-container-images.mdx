...
:::caution
The `cr.seqera.io` container registry is the default Seqera Enterprise container image registry from version 22.4. AWS, Azure, and Google Cloud Seqera container registries in existing installations are still supported but are deprecated for **new installations** from June 2023.
:::
