...
:::caution 
You must complete the upgrade of your Platform Enterprise installation to version 24.1.4 before enabling and configuring Studios.
:::
...
Each of the provided environments includes a particular version of the underlying data analytics software package.
