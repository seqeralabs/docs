...
description: "An introductory overview of Nextflow"
date: "8 Jul 2024"
tags: [nextflow]
---
...
- **Flexibility**: Switching between environments (such as from your local computer to HPC or cloud) requires setting up account keys and credentials to the environment on your CLI, followed by using the appropriate Nextflow configuration settings.

For Nextflow data analysis workflows, [Seqera Platform](./002_what_is_the_seqera_platform.mdx) unlocks management and collaboration for organizations at any scale. 
