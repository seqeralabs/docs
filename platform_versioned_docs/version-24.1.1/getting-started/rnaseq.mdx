...
:::info
**Prerequisites**
This guide includes setting up a cloud compute environment in Platform. You need the following to get started:
- [Maintain](../orgs-and-teams/roles.mdx) (or greater) permissions in an existing organization workspace.
...
Select your new run from the **Runas** tab list to view the run details.
...
![Resume a run](./quickstart-demo/assets/sp-cloud-resume-a-run.gif)

To resume a failed or canceled run in your own workspace:
