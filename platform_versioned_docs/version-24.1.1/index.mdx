...
![Seqera biotech stack](./getting-started/quickstart-demo/assets/seqera-biotech-stack.png)
...
- Access libraries of production-proven Nextflow community pipelines available from [nf-core](https://nf-co.re/)
...
- To skip the Showcase and begin adding your own pipelines and resources, see [Start collaborating](./getting-started/start-collaborating.mdx) to first create your own organizations and workspaces. 
