...
Create a namespace to isolate Kubernetes resources used Seqera Platform from the other resources on your cluster.

NOTE: this installation guide assume the of `seqera-platform` as installation namespace. Consider using a different one that better fit your cluster naming convention. 
...
spec:
  ...
      containers:
        - name: frontend
          image: cr.seqera.io/private/nf-tower-enterprise/frontend:v24.1.1-unprivileged
          env:
