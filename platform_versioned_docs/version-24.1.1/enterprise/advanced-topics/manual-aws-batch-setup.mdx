...
:::caution 
AWS Graviton instances (ARM64 CPU architecture) are not supported in manual compute environments. To use Graviton instances, create your AWS Batch compute environment with [Batch Forge](../../compute-envs/aws-batch.mdx#batch-forge-compute-environment).
:::
...
1. Select **Amazon EC2** as the compute environment configuration.
    :::note
    Seqera AWS Batch compute environments created with [Batch Forge](../../compute-envs/aws-batch.mdx#batch-forge-compute-environment) support using Fargate for the head job, but manual compute environments must use EC2.
    :::
...
Use the AWS resources created on this page to create your [manual AWS Batch compute environment](../../compute-envs/aws-batch.mdx#manual).
