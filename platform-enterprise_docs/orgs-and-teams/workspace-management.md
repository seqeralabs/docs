...
:::note
Data lineage is not enabled by default. See [Configuration options](../enterprise/configuration/overview#data-features).
:::

Once enabled, select **Settings > Lineage** to open the **Edit lineage settings** form:
