...
| | List datasets (legacy endpoint) | `GET /workspaces/{workspaceId}/datasets` |
...
| | Create dataset (legacy endpoint) | `POST /workspaces/{workspaceId}/datasets` |
...
| | Delete dataset (legacy endpoint) | `DELETE /workspaces/{workspaceId}/datasets/{datasetId}` |
...
| **workflow_quick:execute** | Create quick launch | Sub-operation on `POST /workflow/launch` |
...
| **studio:admin** | Delete studio | Sub-operation on `DELETE /studios/{sessionId}` |
...
| **workspace:admin** | Workspace admin operations | |
| **workspace:admin** | Promote user to owner role | Sub-operation on `PUT /orgs/{orgId}/workspaces/{workspaceId}/participants/{participantId}/role` |
| | Remove an owner from a workspace | Sub-operation on `DELETE /orgs/{orgId}/workspaces/{workspaceId}/participants/{participantId}` |
...
| **workspace_workflow_report:read** | Download workflow workspace content | _(Used by Platform)_ |