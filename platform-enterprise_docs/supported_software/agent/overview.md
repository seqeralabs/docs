...
- The login node can make outbound HTTPS connections to your Seqera Platform API endpoint.
...
If you are using Seqera Platform Enterprise (on-prem), set the API URL to point to your installation:

```bash
export TOWER_ACCESS_TOKEN=<YOUR TOKEN>
export TOWER_API_ENDPOINT=https://your-enterprise-host/api
./tw-agent <YOUR CONNECTION ID>
```
...
Environment=TOWER_API_ENDPOINT=https://your-enterprise-host/api
