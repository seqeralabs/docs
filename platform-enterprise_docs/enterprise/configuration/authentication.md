...
2. When creating the OAuth App, specify the following path as callback URL: `https://<deployment-domain-name>/oauth/callback/github` (replace `<deployment-domain-name>` with the domain name of your deployment).
