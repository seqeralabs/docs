...
The database connection pool size should be configured based on your expected concurrent workflow load. Each backend instance maintains its own connection pool to the database.
