...
This guide describes how to deploy the pipeline optimization service (referenced as `Groundswell` in the configuration file) for Seqera Platform Enterprise with Docker Compose.
