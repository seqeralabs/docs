...
![genstats_config_cols](../../images/genstats_config_cols.png)
...
for more on how to customize the flat / interactive plot behaviour.
...
![plot_export](../../images/plot_export.png)
...
for use in publications and manual customization / annotation. The
...
![plot_percentage_button](../../images/plot_percentage_button.png)
...
customize the highlight colour.
