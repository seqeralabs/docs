...
Organizations are the top-level structure and contain workspaces, members, and teams. You can also add external collaborators to an organization. See [Organization management](/platform-cloud/orgs-and-teams/organizations) for more information.
