...
The CLI documentation follows a **standalone docset strategy**:
- CLI docs are now a separate docset at `/platform-cli`
- Platform Cloud and Enterprise docs link to CLI docs externally
- No duplication of CLI docs across docsets
- Versioned Enterprise docs link to the standalone CLI docs
...
**Location:** `platform-cli-docs/scripts/generate-cli-docs.py`
...
**Location:** `platform-cli-docs/scripts/compare-metadata.py`
