...
The Seqera CLI runs in your terminal on macOS, Linux, or Windows (via WSL). It connects to Seqera Platform and to an AI backend so you can build, run, and debug Nextflow pipelines from a single interactive session.
