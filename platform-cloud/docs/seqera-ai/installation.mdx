...
To install the CLI use Platform's install endpoint, run:
...
To install the latest pre-release use Platform's development install endpoint and pass in channel flag:
