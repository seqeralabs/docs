...
- Platform Cloud docs use the CLI docs directly
- Platform Enterprise copies CLI docs during automated updates
...
python platform-cloud/docs/cli/scripts/generate-cli-docs.py \
  --metadata platform-cloud/docs/cli/metadata/cli-metadata-v0.9.3.json \
...
### 5. Copy to Enterprise

```bash
cp -r platform-cloud/docs/cli/reference platform-enterprise_docs/cli/
cp platform-cloud/docs/cli/commands-reference.md platform-enterprise_docs/cli/
```

Enterprise docs receive a copy of the generated documentation.
