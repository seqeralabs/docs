...
| **Workspace: Pipeline:** Modify execution configurations  | ✔     | ✔     | ✔        | ✖     | ✖      | ✖   |
| **Workspace: Pipeline:** Add, edit, duplicate, delete  | ✔     | ✔     | ✔        | ✔     | ✖      | ✖   |
| **Workspace: Pipeline: Run:** Apply labels, relaunch, save as new pipeline  | ✔     | ✔     | ✔        | ✖     | ✖      | ✖   |
| **Workspace: Pipeline: Run:** Resume, delete, star (favourite)  | ✔     | ✔     | ✔        | ✔     | ✖      | ✖   |
...
| **Workspace: Studios:** List/search/view studio sessions          | ✔     | ✔     | ✔        | ✔      | ✔       | ✔    |
