...
<Button to="./_policies/aws-cloud-full-policy.json" medium>Download aws-cloud-full-policy.json</Button>
...
<Button to="./_policies/aws-cloud-intelligent-compute-policy.json" medium>Download aws-cloud-intelligent-compute-policy.json</Button>
