...
If you enable [data lineage](../data/data-lineage) in your workspace, add the following permissions to your Platform integration credentials so Platform can create the notification topic and bucket notifications used by the lineage service:
