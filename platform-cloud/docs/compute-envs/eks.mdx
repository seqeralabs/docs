...
import EksFullPolicy from './_policies/eks-full-policy.json?raw';
...
<CodeBlock language="json">{EksFullPolicy}</CodeBlock>

</details>

[Download eks-full-policy.json](./_policies/eks-full-policy.json)
