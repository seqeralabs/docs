...
- CPU time: 1 CPU/Hr = 0.1 credit
- Memory: 1 GiB/Hr = 0.025 credit 
- Storage: 1 GB = 0.25 credit per month 

:::note 
Storage and network costs vary per region, charged at standard AWS rates. Data ingress and egress across regions incure additional cost. 
:::
