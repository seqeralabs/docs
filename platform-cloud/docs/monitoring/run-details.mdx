...
- Work directory path. If your work directory resides in cloud storage, select the work directory path in the **General** panel to browse its contents in [Data Explorer](../data/data-explorer.mdx).
- Container image
- Executor
...
- **Container**
  ...
  The **Container** tab shows the container details used to run the task.

The **Container** panel displays the container details used to run the pipeline, including:
