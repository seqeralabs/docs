...
The **Inputs** and **Outputs** tabs show every input or output consumed by the task, including the name and the lineage labels assigned to it. Select a name to open the file in [Data Explorer](../data/data-explorer).
:::
