...
Select a task in the task table to open the **Task details** dialog. The dialog has the following tabs: **About**, **Execution log**, **Data Explorer**, and **Container**.  If lineage is enabled for the run, the dialog also includes **Inputs** and **Outputs** tabs.
