...
- The **containers** used in the pipeline run.
...
- **Container**
  ...
  The **Container** tab shows the container details used to run the task, including links to Wave reports, if wave is used.

### Container Details
The **Container** panel displays the container details used to run the pipeline. The container details include:
  ...
  - **Build ID**: The unique build ID assigned when the container was provisioned, and link to the container build report in Wave.
  - **Mirror ID**: The unique mirror ID assigned when the container was copied between repositories, and link to the container mirror report in Wave.
  - **Scan ID**: The unique scan ID from the vulnerability security scan of the container, and link to the scan report in Wave.
