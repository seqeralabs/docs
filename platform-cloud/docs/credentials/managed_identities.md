...
Documentation for this credential type now lives at [/platform-cloud/integrations/identity/managed-identities](/platform-cloud/integrations/identity/managed-identities). The old URL is preserved during the migration but will be removed in a future release. Update your bookmarks.
:::
