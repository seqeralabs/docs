...
If you're restricted from using public container registries, see Seqera Enterprise release [instructions](https://docs.seqera.io/platform-enterprise/latest/enterprise/release_notes/23.2#nextflow-launcher-image) for the specific image to set as the default when invoking pipelines.
