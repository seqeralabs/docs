...
When you configure or use [single sign-on (SSO)](../getting-started/single-sign-on) with your organization's corporate identity provider (IdP), you might encounter the following issues.
