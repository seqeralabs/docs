...
## Deployment
- **Usage:** Local Claude Code only
- **CI/CD:** Not used in workflows
- **Invocation:** Manual, when formatting Platform changelogs
- **Scope:** Platform Cloud and Enterprise changelogs only
