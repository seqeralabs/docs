...
Both the [Seqera Platform CLI](https://docs.seqera.io/platform-cloud/cli/overview.mdx) and [seqerakit](https://docs.seqera.io/platform-cloud/seqerakit/installation) are built on the Platform API and provide a programmatic automation layer for operations.
