...
<<<<<<< HEAD
  children={"Version: 1.109.0"}
=======
  children={"Version: 1.102.0"}
>>>>>>> origin/master
>
</span>
...
The Seqera API uses the OpenAPI standard. The current OpenAPI specification file can be found [here](https://cloud.seqera.io/openapi/seqera-api-latest.yml).
