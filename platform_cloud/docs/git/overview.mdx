...
Seqera Platform Enterprise supports Git server endpoints. For more information, see [Git configuration](../../version-24.2/enterprise/configuration/overview.mdx#git-integration) in the Enterprise installation guide.
