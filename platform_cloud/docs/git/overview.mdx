...
Seqera Platform Enterprise supports Git server endpoints. For more information, see [Git configuration](https://docs.seqera.io/platform/latest/enterprise/configuration/overview.mdx#git-integration) in the Enterprise installation guide.
