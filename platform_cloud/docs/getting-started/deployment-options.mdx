...
[Seqera Enterprise](https://docs.seqera.io/platform/latest/enterprise/index.mdx) is installed in an organization's own cloud or on-premises infrastructure. It includes:
