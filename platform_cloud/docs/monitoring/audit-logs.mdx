...
:::info
Application event audit logs are retained for 365 days by default. In Platform Enterprise, this retention period can be [customized](https://docs.seqera.io/platform/latest/enterprise/configuration/overview.mdx#logging).
:::
