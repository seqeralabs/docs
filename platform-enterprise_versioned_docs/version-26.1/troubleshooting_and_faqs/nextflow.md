...
If you run a Nextflow version earlier than 25.10, increase the upload chunk size. Divide the file size in megabytes by 10,000 and round up to get the minimum chunk size. For a 200 GB file, set `uploadChunkSize` to at least 21 MB in the **Nextflow config file** field of the launch form:
