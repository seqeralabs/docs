...
Show the authenticated user, the agent backend, and Seqera Platform connection details. Use it to confirm that the CLI points at your Enterprise deployment.
