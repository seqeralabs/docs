...
The Wave integration also allows for the secure transfer of credentials required to access private registries between services. See the [Tower documentation](https://docs.seqera.io/platform-enterprise/23.3.0) to learn how to use the feature in your enterprise installation.
