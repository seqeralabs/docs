...
date: "21 Jul 2024"
tags: [platform, seqera pipelines, data studios, rnaseq, compute environments, aws]
...
**Data Studios** streamlines the process of creating interactive analysis environments for Platform users. With built-in templates for platforms like Jupyter Notebook, an R-IDE, and VSCode, creating a data studio is as simple as adding and sharing pipelines or datasets. The data studio URL can also be shared with any user with the [Connect role](../orgs-and-teams/roles) for real-time access and collaboration.
...
### Create an R-IDE analysis environment with Data Studios
