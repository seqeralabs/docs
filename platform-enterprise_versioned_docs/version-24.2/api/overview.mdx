...
<p>
  <Button
    to="https://cloud.seqera.io/openapi/index.html"
    className="mr-3"
    blue
    medium
    alt
  ...
  <Button
    to="https://cloud.seqera.io/openapi/seqera-api-latest.yml"
    secondary
    medium
    alt
  >
...
<Button to="https://cloud.seqera.io/tokens" secondary medium alt>
