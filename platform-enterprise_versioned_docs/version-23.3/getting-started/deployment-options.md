...
Seqera Platform is available in two deployment editions and can be accessed via the web user interface (UI), [API](https://docs.seqera.io/platform-api), [CLI](https://docs.seqera.io/platform-cli), or in Nextflow directly using a flag.
