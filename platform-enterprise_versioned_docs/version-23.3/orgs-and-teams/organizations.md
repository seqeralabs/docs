...
As an **organization owner**, access the organization page from the organizations and workspaces drop-down menu, or open the user menu and select **Your organizations** to view and edit your organizations. As a root user, you can also edit organizations from the [Admin panel](../administration/overview).
...
New collaborators to an organization's workspace can be added as **Participants** from the workspace page. See [participant roles](./workspace-management#participant-roles) to learn more about participant access levels.
