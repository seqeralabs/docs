...
<Button to="https://cloud.seqera.io/tokens" alt secondary medium>
  Create an access token
</Button>
:::

<Button to="https://cloud.seqera.io/openapi/index.html" alt blue medium>
  Platform OpenAPI reference
</Button>{" "}
...
<Button
  ...
  medium
>
  Download Platform OpenAPI schema
</Button>
