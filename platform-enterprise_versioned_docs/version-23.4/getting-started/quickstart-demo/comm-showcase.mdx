...
- Perform tertiary analysis of pipeline results with [Data Studios](../../data/data-studios)
...
:::note
See [Data Studios](../../data/data-studios) to learn how to create data studios in your own workspace. 
:::
