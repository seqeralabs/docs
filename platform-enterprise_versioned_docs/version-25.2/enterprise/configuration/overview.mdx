...
:::tip 
See the **tower.yml** and **AWS Parameter Store** tables in the preceding section for configuration parameters corresponding to the environment variables above.
:::
...
:::warning 
- To prevent the loss of data, perform a backup of your Platform database and securely back up your current crypto secret key before enabling and performing key rotation. 
