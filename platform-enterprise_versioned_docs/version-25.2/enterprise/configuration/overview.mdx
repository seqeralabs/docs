...
These default memory allocation limits are set in your Kubernetes manifests or Docker Compose configurations.
...
Ensure pod memory limits are set higher than JVM limits to accommodate non-heap memory usage.
