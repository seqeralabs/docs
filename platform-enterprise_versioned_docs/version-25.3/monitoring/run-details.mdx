...
tags: [logging, monitoring, runs, details, workflows, execution]
---
...
- Use the options menu to apply labels, relaunch, resume, or delete the run, save the run as a new pipeline, or publish a new pipeline [version](../pipelines/versioning) (if the run was launched from a draft version).
