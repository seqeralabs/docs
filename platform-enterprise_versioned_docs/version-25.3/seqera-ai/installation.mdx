...
See [Install Seqera AI](../enterprise/install-seqera-ai.md#connect-the-cli-to-seqera-ai) for the complete environment variable reference and OAuth versus token-based examples.
