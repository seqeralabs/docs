...
const InterFont = fetch(`${baseUrl}/fonts/inter/Inter-Regular.ttf`).then((res) => res.arrayBuffer());
const DegularFont = fetch(`${baseUrl}/fonts/degular/Degular-Bold.woff`).then((res) => res.arrayBuffer());
const DegularFontLight = fetch(`${baseUrl}/fonts/degular/Degular-Regular.woff`).then((res) => res.arrayBuffer());
