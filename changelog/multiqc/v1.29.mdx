...
- Added option `--only-samples` - opposite of `--ignore-samples` ([#3174](https://github.com/MultiQC/MultiQC/pull/3174))
...
- Added timeout to plot export ([#3111](https://github.com/MultiQC/MultiQC/pull/3111))
...
- Fixed false auto-opening toolbox when SeqeraAI is selected ([#3193](https://github.com/MultiQC/MultiQC/pull/3193))
- Fixed applying `data_labels` extra parameters in plot config ([#3181](https://github.com/MultiQC/MultiQC/pull/3181))
...
- Fixed barplot CSV in-browser export ([#3148](https://github.com/MultiQC/MultiQC/pull/3148))
- Fixed setting `custom_table_header_config` for custom table ([#3135](https://github.com/MultiQC/MultiQC/pull/3135))
- Coerce x-values to float when setting x-range on linegraph ([#3130](https://github.com/MultiQC/MultiQC/pull/3130))
- Fixed pre-configured table sort `defaultsort` ([#3140](https://github.com/MultiQC/MultiQC/pull/3140))
- Fixed barplot CSV in-browser export ([#3148](https://github.com/MultiQC/MultiQC/pull/3148))
- AI summaries:
