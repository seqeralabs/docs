...
- Added JSON schema for config ([#3100](https://github.com/MultiQC/MultiQC/pull/3100))
...
- Fixed generating AI summaries from custom content table with empty cells ([#3095](https://github.com/MultiQC/MultiQC/pull/3095))
- Bargraph: respect `pconfig.use_legend` if defined ([#3112](https://github.com/MultiQC/MultiQC/pull/3112))
- Fixed warnings when `read_count_multiplier: 1` ([#3094](https://github.com/MultiQC/MultiQC/pull/3094))
...
- Refactored plotting code to save and load input data ([#3069](https://github.com/MultiQC/MultiQC/pull/3069))
