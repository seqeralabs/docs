...
- Added table tooltips about merged values in groupped samples ([#3002](https://github.com/MultiQC/MultiQC/pull/3002))
...
- Added Cursor rules for module creation ([#3025](https://github.com/MultiQC/MultiQC/pull/3025))
- Fixed docker build: remove docs from `.dockerignore` ([#2994](https://github.com/MultiQC/MultiQC/pull/2994))
- Added workflow to sync changelog with Seqera docs ([#2993](https://github.com/MultiQC/MultiQC/pull/2993))
...
- Fixed Docker CI for forks: skip login step ([#2953](https://github.com/MultiQC/MultiQC/pull/2953))
- Document bar plot's `sort_samples` ([#3006](https://github.com/MultiQC/MultiQC/pull/3006))
- Updated ruff to 0.8.3 ([#3029](https://github.com/MultiQC/MultiQC/pull/3029))
- Added more tests for custom-content ([#3028](https://github.com/MultiQC/MultiQC/pull/3028))
- Added pytest ini options to `pyproject.toml` - to set default test targets ([#3030](https://github.com/MultiQC/MultiQC/pull/3030))
