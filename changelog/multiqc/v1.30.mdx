...
- Color schemes: lighten colors with alpha instead of admixing white ([#3252](https://github.com/MultiQC/MultiQC/pull/3252))
- Performance: use `OrderedDict` for `saved_raw_data_keys` ([#3235](https://github.com/MultiQC/MultiQC/pull/3235))

### Fixes

- Fixed series labels in heatmap subtitle ([#3260](https://github.com/MultiQC/MultiQC/pull/3260))
- Fixed custom content description when grouping section with `parent_id` ([#3242](https://github.com/MultiQC/MultiQC/pull/3242))
- Fixed timezone issue in parquet export ([#3224](https://github.com/MultiQC/MultiQC/pull/3224))
