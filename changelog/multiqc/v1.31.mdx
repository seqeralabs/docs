...
- Added `return_html` parameter for programmatic HTML access ([#3304](https://github.com/MultiQC/MultiQC/pull/3304))
...
- Fixed bulk sample renaming buttons ([#3300](https://github.com/MultiQC/MultiQC/pull/3300))
- Fixed config flag types in schema ([#3318](https://github.com/MultiQC/MultiQC/pull/3318))
...
- Added Claude instructions ([#3301](https://github.com/MultiQC/MultiQC/pull/3301))
- Added Claude review action ([#3299](https://github.com/MultiQC/MultiQC/pull/3299))
