...
- Added natural sort for sample sorting ([#2959](https://github.com/MultiQC/MultiQC/pull/2959))
...
- Fixed table CSV export where a title contains a comma ([#2911](https://github.com/MultiQC/MultiQC/pull/2911))
...
- Fixed `cond_formatting_rules` type hint to avoid validation error ([#2922](https://github.com/MultiQC/MultiQC/pull/2922))
- Fixed `config.prepend_dirs` or `-d -dd 1` ([#2913](https://github.com/MultiQC/MultiQC/pull/2913))
