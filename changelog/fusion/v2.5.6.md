...
- Files were incorrectly treated as directories causing workflow failures.
...
- golangci-lint-action: 8.0.0 → 9.0.0
- actions/upload-artifact: 4.6.2 → 5.0.0
- actions/download-artifact: 5.0.0 → 6.0.0
- astral-sh/setup-uv: 6 → 7
- mikepenz/action-junit-report: 5.6.2 → 6.0.0
- Multiple gomod dependency updates
