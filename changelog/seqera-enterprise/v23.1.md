...
Tower 23.1 introduces support for the Fusion file system in Google Cloud Batch environments. Fusion is a distributed, lightweight file system for cloud-native pipelines that improves performance by up to ~2.2x compared to cloud native object storage.
