...
2. Download the 23.4 versions of your deployment templates and update your Seqera container versions:
    - [docker-compose.yml](https://github.com/seqeralabs/docs/blob/master/platform-enterprise_versioned_docs/version-23.4/enterprise/_templates/docker/docker-compose.yml) for Docker Compose deployments
    - [tower-cron.yml](https://github.com/seqeralabs/docs/blob/master/platform-enterprise_versioned_docs/version-23.4/enterprise/_templates/k8s/tower-cron.yml) and [tower-svc.yml](https://github.com/seqeralabs/docs/blob/master/platform-enterprise_versioned_docs/version-23.4/enterprise/_templates/k8s/tower-svc.yml) for Kubernetes deployments
