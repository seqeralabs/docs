...
[Pipeline versioning](https://docs.seqera.io/platform-cloud/pipelines/overview) introduces versioning and controls to pipeline launches so users always know what ran, who changed it, and users can run it again exactly the same way. 
...
- Implemented pipeline version indexing.

#### Datasets

The Datasets experience in Seqera has been updated.
...
- Improved AWS Batch workflow behavior to automatically terminate unschedulable jobs instead of leaving them pending indefinitely, providing faster feedback when compute resources are insufficient for workflow requirements.
