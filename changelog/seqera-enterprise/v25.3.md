...
- Added Git repository integration to Add Studio page, supporting loading the configuration from private and public repostiories.
- Added ability to clone the content of the git repo in the studio at startup time in a configurable path
