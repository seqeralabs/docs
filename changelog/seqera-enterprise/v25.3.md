...
See [Kubernetes](https://docs.seqera.io/platform-enterprise/enterprise/platform-kubernetes#seqera-frontend-unprivileged) and [docker-compose](https://docs.seqera.io/platform-enterprise/enterprise/platform-docker-compose#seqera-frontend-unprivileged) deployment documentation for instructions.
