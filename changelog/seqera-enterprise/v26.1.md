...
Seqera Enterprise v26.1 broadens and scales the platform's capabilities across AI, pipeline launches, cloud infrastructure, data management, and compliance.
...
- Audit logs have a new user interface with on-demand CSV export with configurable max records and richer event context, while the Admin panel exposes real-time usage metrics.
...
- [Co-Scientist for Enterprise](https://docs.seqera.io/platform-enterprise/enterprise/install-seqera-coscientist).
...
- Added `m8gn`, `m8gb`, `c8id`, `m8id`, `r8id`, `x8aedz`, `g7e`,`p6-b300`, `x8aedz` instance families to NVMe list.
