...
- Pipelines support a GitHub App manifest flow for credential creation, with higher throughput than personal access tokens (PATs).
...
- Datasets support linked (URL-referenced) remotely-hosted data.
