...
- [Co-Scientist](https://docs.seqera.io/platform-enterprise/co-scientist/) is now available for Enterprise deployments.
- Pipelines now support a [GitHub App](https://docs.seqera.io/platform-enterprise/git/overview#github-app) manifest flow for credential creation, with higher throughput than personal access tokens (PATs).
- [Compute environments support descriptions and can be disabled](https://docs.seqera.io/platform-enterprise/compute-envs/overview#disable-compute-environment), and Google Batch and Azure Batch have significant stability and scalability improvements.
- AWS, Azure, and GCP each gain deeper credential and identity management, including [Workload Identity Federation (WIF) for Google Cloud Batch](https://docs/seqera.io/platform-enterprise/compute-envs/google-cloud-batch#iam) and [Entra service principal support](https://docs.seqera.io/platform-enterprise/compute-envs/azure-batch#credentials) for Azure Batch.
- [Nextflow data lineage](https://docs.seqera.io/platform-enterprise/data/data-lineage) is configurable and attached to pipeline runs and Data Explorer objects.
- Existing Studios can be edited, and new workspace settings for custom container registry controls and default collaboration modes provide top-down granular management.
- [Datasets now support linked (URL-referenced) remotely-hosted data](https://docs.seqera.io/platform-enterprise/data/datasets#link-to-an-externally-hosted-file).
- Data Explorer adds IGV and Molstar 3D viewer for genomic and structural files, respectively.
- [Audit logs](https://docs.seqera.io/platform-enterprise/monitoring/audit-logs) have a new user interface with on-demand CSV export, configurable maximum records, and richer event context. The Admin panel exposes real-time usage metrics.
...
- Added support for [Co-Scientist](https://docs.seqera.io/platform-enterprise/enterprise/install-seqera-coscientist) in Enterprise deployments.

### Studios

- Enabled Studios on all workspaces by default. See the [Upgrade guide](https://docs.seqera.io/platform-enterprise/enterprise/upgrade#studios-enabled-on-all-workspaces-by-default) for more information.
...
- Added new environment variables. See [Data features](https://docs.seqera.io/platform-enterprise/enterprise/configuration/overview#data-features) for the full descriptions and defaults:
  - SSH settings:
    - Allowed workspaces
...
- Added new environment variable. See [Configuration overview](https://docs.seqera.io/platform-enterprise/enterprise/configuration/overview) for the full descriptions and defaults:
...
- Added [configurable retry behavior](https://docs.seqera.io/platform-enterprise/compute-envs/google-cloud-batch#gcp-resources) for tasks with null exit codes in Google Batch compute environments.
