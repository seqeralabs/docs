...
- In a CPU instance type [compute environment](https://docs.seqera.io/platform/24.2/compute-envs/overview), both CPU and GPU resources are supported and can be added to your Data Studios sessions.
- NVMe support added.
