...
- [Azure Batch service principal credentials](https://docs.seqera.io/platform/24.2/compute-envs/azure-batch#credentials) and [managed identities](https://docs.seqera.io/platform/24.2/credentials/managed_identities) prevents spillover of credentials. 
- Filling in the GitLab credentials password field is no longer required for validation.
