...
- A sidebar replaces the Platform top navigation for improved navigation.
- The [pipeline run details](https://docs.seqera.io/platform-enterprise/25.2/monitoring/run-details) page refreshed with these improvements:
  ...
  - The **Tasks** tab defaults to the display for successful runs.
...
- Fixed pipeline secrets not deleted in the context of a personal workspace.
