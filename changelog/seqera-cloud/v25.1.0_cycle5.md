...
- Supported image upload in the pipeline import and pipeline update forms, to be used as pipeline logos.

## Bug fixes

- Fixed a bug where resource labels erroneously allowed editing for the maintain role when starting an existing Studio.
