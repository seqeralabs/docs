...
- Cookie authentication is now supported with auth0
- Auth0 login now redirects after 10s
...
- MemStore implementation based on Jedis
...
- Data Studios form validity is now evaluated from the start
...
- Increase data studio Conda environment textarea size 
...
- No class error when creating Azure Entra credentials
...
- Initialize schema data with pipeline value from control 