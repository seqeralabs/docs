...
- (Enterprise only) Added a job to save usage metrics to files so usage data can be accessed and shared by users even when they're not connected to License Manager.
