...
- Studios:
    - Implement a UI element that displays the currently applied date filter on the Dashboard page.
...
- Fusion:
    ...
    - Add support for Fusion licensing mechanism.
...
- Fixed an additional reference to `mainScript` parameter in a `pipeline-info` call.
