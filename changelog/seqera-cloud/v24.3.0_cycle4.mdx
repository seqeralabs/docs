...
- Add read-only `workflow.requiresAttention` attribute to avoid possible race conditions while updating the workflow messages and other workflow entities at the same time.
