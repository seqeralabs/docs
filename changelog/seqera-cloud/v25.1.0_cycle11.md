...
The [Seqera Platform API documentation](https://docs.seqera.io/platform-api) has been updated. Featuring overview pages with parameter and request body tables, categorized by Platform entity (compute environments, pipelines, etc.), the documentation now provides easier reference and detailed request examples.
