...
Refreshed the [pipeline run details](https://docs.seqera.io/platform-cloud/monitoring/run-details) page with improvements such as:
...
Updated the [Seqera Platform API documentation](https://docs.seqera.io/platform-api). Featuring overview pages with parameter and request body tables, categorized by Platform entity (compute environments, pipelines, etc.), the documentation now provides easier reference and detailed request examples.
