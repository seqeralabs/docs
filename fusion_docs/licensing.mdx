...
If Fusion is unable to verify the license provided by Nextflow, the pipeline exits with an error. If the license is valid, but expires between retrieval and validation by Fusion, Nextflow exits with an error code.
