...
Yes. [Minio](https://min.io/) implements an S3-compatible API, therefore it can be used instead of AWS S3. See [Local execution](/fusion_docs/guide/local.mdx) for more information.
