...
:::note 
Fusion is free to test in Seqera Platform compute environments or directly within Nextflow, but requires a license for production use. [Contact Seqera](https://seqera.io/contact-us/) for more details.
:::
