...
### Platform Enterprise: Select an Amazon Linux 2023 ECS-optimized AMI 
...
:::note
Selecting an Amazon Linux 2023 ECS-Optimized AMI is only required for Seqera Enterprise instances. Seqera Cloud AWS Batch compute environments select this AMI by default. 
:::
