---
title: GKE
description: "Use Fusion with GKE and Google Cloud Storage"
date: "23 Aug 2024"
...
See [Google Kubernetes Engine](https://docs.seqera.io/platform/latest/compute-envs/gke) for Platform instructions to enable Fusion.
...
To use Fusion with without the need for escalating privileges, install the Nextflow [FUSE device plugin](https://github.com/nextflow-io/k8s-fuse-plugin) on your Kubernetes cluster and add set `fusion.privileged` to `false` in your `nextflow.config` file:
