---
title: Nextflow CLI local execution
...
<TabItem value="Azure Blob Storage" label="Azure Blob Storage" default>
  ...
  1. Set `AZURE_STORAGE_ACCOUNT_NAME` and `AZURE_STORAGE_ACCOUNT_KEY` environment variables to grant Nextflow and Fusion access to your storage credentials.
