---
title: Local execution with MinIO
description: "Use Fusion with the Nextflow local executor and MinIO"
date: "23 Aug 2024"
tags: [fusion, storage, compute, local, minio]
---

With Fusion, you can run Nextflow pipelines using the local executor and MinIO. This
...
Minio is an open source, enterprise grade, object storage compatible with AWS S3.
